...
* Mon Apr 03 2023 23:54:10 GMT-0700 (PDT)
* Source doc: Develop and Test Apache Spark Apps for EMR Remotely Using Visual Studio Code
...
Now we have two users that have access to the EMR cluster and their connection details are saved into a [SSH configuration file](https://linuxize.com/post/using-the-ssh-config-file/) as shown below.
