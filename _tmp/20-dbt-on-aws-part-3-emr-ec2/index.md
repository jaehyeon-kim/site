...
* Mon Apr 03 2023 23:55:33 GMT-0700 (PDT)
* Source doc: Data Build Tool (dbt) for Effective Data Transformation on AWS - Part 3 EMR on EC2
...
The [previous post](https://cevo.com.au/post/simplify-your-development-on-aws-with-terraform/) demonstrates how to create a VPN user and to establish connection in detail. An example of a successful connection is shown below.
